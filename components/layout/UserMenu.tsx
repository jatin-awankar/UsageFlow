...
export default function UserMenu({
  ...
  return (
    <Menu as="div" className="relative">
      <MenuButton className="inline-flex items-center gap-2 rounded-lg border border-slate-200 bg-white px-2 py-1.5 text-sm text-slate-700 shadow-sm transition hover:bg-slate-50 hover:cursor-pointer">
        ...
        <span className="hidden max-w-40 truncate sm:block">{email}</span>
      </MenuButton>

      <MenuItems className="absolute right-0 z-30 mt-2 w-56 origin-top-right rounded-xl border border-slate-200 bg-white p-1.5 shadow-lg outline-none animate-in fade-in zoom-in-95 duration-150">
