...
export default function AuditLogsPagination({
  ...
  return (
    <div className="flex items-center justify-between gap-2 rounded-xl border border-slate-200 bg-white/80 px-3 py-2 shadow-sm animate-in fade-in duration-500 [animation-delay:180ms]">
      {hasPrev && prevCursor ? (
